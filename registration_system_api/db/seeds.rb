...
#
  ...
  device = Device.create(name: "Roger's Personal Hotspot", library_device_id: 'xxx', location: 'Toronto', deposit_amount: 20, url: 'https://www.rogers.com/cms/rogers-smb-new/page-specific/products-and-solutions/mobile-internet-plans/Images/550x300_ZTEhotspot.png')
